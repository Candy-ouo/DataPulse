...
export default function BarChart({ data = [], title }) {
  const options = {
    ...
    xAxis: {
      ...
      axisLabel: { color: 'rgba(255,255,255,0.5)', fontSize: 11, rotate: 30, interval: 0, margin: 8 },
    ...
    series: [{
      type: 'bar', data: data.map((d) => d.value || 0), barWidth: '55%',
      itemStyle: { borderRadius: [3, 3, 0, 0], color: { type: 'linear', x: 0, y: 0, x2: 0, y2: 1, colorStops: [{ offset: 0, color: '#00d4ff' }, { offset: 1, color: 'rgba(0,180,216,0.3)' }] } },
